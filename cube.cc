...
int main()
{
   ...
   vhandle[2] = mesh.add_vertex(MyMesh::Point( -2, 1, 0));
   vhandle[3] = mesh.add_vertex(MyMesh::Point(0, 1, 0));
   vhandle[4] = mesh.add_vertex(MyMesh::Point(2, 2, 0));
   vhandle[5] = mesh.add_vertex(MyMesh::Point( 1, 0, 0));
   vhandle[6] = mesh.add_vertex(MyMesh::Point( 3, -1, 0));
   vhandle[7] = mesh.add_vertex(MyMesh::Point( 0, -2, 0));;
